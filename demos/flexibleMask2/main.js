...
function main(){ // entry point
  ...
  WebARRocksFaceThreeHelper.init({
    // First gen neural net: NN_FACE_<X> with X <= 2
    /*spec:  {
      NNCPath: '../../neuralNets/NN_FACE_1.json'
    },
    ...
    // tweak points position and labels used for pose computation
    // to avoid mask stuttering issue:
    //*/

    // Second gen neural net: NN_FACE_<X> with X >= 3
    spec:  {
