...
// ASSETS:
import makeupTextureImage from '../../assets/makeupTexture/makeup.png'
...
const MakeupTexture = (props) => {
  const [sizing, setSizing] = useState(compute_sizing())
  const [shapes, setShapes] = useState([SHAPEFACE])
 ...
 const do_resize = () => {
  ...
  return (
    <div>
      <canvas ref={canvasARRef} className='mirrorX' style={{
        position: 'fixed',
        zIndex: 2,
        ...sizing
      }} width = {sizing.width} height = {sizing.height} />

      <canvas className='mirrorX' ref={canvasVideoRef} style={{
        position: 'fixed',
        zIndex: 1,
        ...sizing
      }} width = {sizing.width} height = {sizing.height} />
