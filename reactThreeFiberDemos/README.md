# WebAR.rocks.face React Three Fiber Demos
...
The main script and neural network models have been copied to [src/js/contrib/WebARRocksFace/dist](src/js/contrib/WebARRocksFace/dist) and [src/js/contrib/WebARRocksFace/neuralNets](src/js/contrib/WebARRocksFace/neuralNets).

The helpers have been modified compared to the static ones. They are in [src/js/contrib/WebARRocksFace/helpers](src/js/contrib/WebARRocksFace/helpers)
